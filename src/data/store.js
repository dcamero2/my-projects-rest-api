...
let tasks = [
  {
    id: 1,
    project_id: 1,
    title: 'Add mobile features',
    description: 'Make web application compatible with mobile devices.',
    status: 'in_progress',
    create_at: seededAt,
    updated_at: seededAt,
  },
  {
    id: 2,
    project_id: 1,
    title: 'Finalize web application',
    description: 'Finish coding and deploy web application.',
    status: 'todo',
    create_at: seededAt,
    updated_at: seededAt,
  },
  {
    ...
    project_id: 2,
    title: 'Update resume',
    description: 'Add information to skillset in resume.',
    status: 'done',
    create_at: seededAt,
    updated_at: seededAt,
  },
